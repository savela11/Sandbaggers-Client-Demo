  ...
  <div class='contacts'>
    <div v-if='!loading'>
      ...
      <div class='contactList' v-if='filteredContacts.length > 0'>
        <div class='contact' v-for='contact in filteredContacts' :key='contact.id'>
          <div class='image'>
            <img :src='contactImage(contact.image)' alt='logo' />
          </div>
          <div class='inner'>
            <div class='top'>
...
@use "~@/assets/styles/views/contact/_contacts";
</style>

<template>
    <div class="myBets">
        <div v-if="!loading">
            ...
            <div class="bet-list">
                <Card v-for="bet in filteredBets" :key="bet.betId" :additional="true" class="card-component" main-class='' header-class='flex--between flex--items-center' footer-class='flex--end'>
                    <template v-slot:card--header>
                        <p class="card__text card__text--alt">Created: {{ formatDate(bet.createdOn) }}</p>
                        <p class="card__text card__text--alt">
                            Accepted:
                    ...
                    <template v-slot:card--footer>
                        <router-link :to="`/MyBets/${bet.betId}`" class="card__btn card__btn--edit">Edit</router-link>
                    </template>
                </Card>
            </div>
        </div>

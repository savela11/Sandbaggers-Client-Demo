        ...
        <div v-if='currentUser && currentUser.profile'>
            ...
            <section v-if='!loading' class='section section__bottom'>
                <div class='view profile' v-if="currentView.title === 'Profile'">
                    <form class='form' @submit.prevent.stop='updateCurrentUser'>
                        ...
                        <input type='submit' value='Update' class='text--btn-update'>
                    </form>

                </div>

                <!--      Settings -->
                <ProfileSettings v-if="currentView.title === 'Settings'" class='view settings' :settings='currentUser.settings' @update-settings='updateSettings' />
                <!--Bets-->
...
import { FavoriteLinkVm, UserSettingsVm, UserVm } from '@/types/ViewModels/Models/UserVm'
...
@Component({
    ...
    components: {
        ...
        ProfileSettings: (): Promise<typeof import('*.vue')> => import('@/views/userProfile/profileSettings.vue'),
...
export default class UserProfile extends Vue {
    ...
    async updateSettings(settings: UserSettingsVm): Promise<void> {
...
@use "~@/assets/styles/views/userProfile/_userProfile";
</style>
